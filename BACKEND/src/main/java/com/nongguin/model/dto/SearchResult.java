...
public class SearchResult {
	...
	public SearchResult(int courtId, String courtName, String courtAddress, String courtTel, String courtDes,
			int courtCapacity, int matchId, int matchFee, Timestamp matchDate, int matchApplicantCnt, String matchLevel,
			String matchGender) {
		super();
	...
	public String toString() {
		return "SearchResult [courtId=" + courtId + ", courtName=" + courtName + ", courtAddress=" + courtAddress
				...
				+ ", matchId=" + matchId + ", matchFee=" + matchFee + ", matchDate=" + matchDate
				+ ", matchApplicantCnt=" + matchApplicantCnt + ", matchLevel=" + matchLevel + ", matchGender="
				+ matchGender + "]";
	}
