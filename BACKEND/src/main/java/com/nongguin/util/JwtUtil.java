...
public class JwtUtil {
	...
	// 토큰 생성 메서드
	public String createToken(String key, String value, String key2, int value2) throws UnsupportedEncodingException {
		return Jwts.builder().setHeaderParam("alg", "HS256").setHeaderParam("type", "JWT") // 헤더 완료
				.claim(key, value).claim(key2, value2).setExpiration(new Date(System.currentTimeMillis() + 1800000)) // 페이로드 완료
